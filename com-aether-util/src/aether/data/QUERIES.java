...
public class QUERIES {
    ...
    public static final String NEW_UPDATE_TABLE_FIELDS = "(id INT PRIMARY KEY AUTO_INCREMENT, from_user VARCHAR(50) NOT NULL, type VARCHAR(10) NOT NULL, update_data TEXT NOT NULL, date_created DATETIME)";
